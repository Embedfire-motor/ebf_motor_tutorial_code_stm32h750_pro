...
#define ADCx_REQUEST										DMA_REQUEST_ADC1
...
#define CURR_ADC_GPIO_PIN               GPIO_PIN_4
#define CURR_ADC_GPIO_CLK_ENABLE()      __GPIOA_CLK_ENABLE()

#define CURR_ADC_CHANNEL                ADC_CHANNEL_18
...
/*********************** AD模拟看门狗门限电压 ******************/
#define VBUS_MAX                        25    // 电压最大值
#define VBUS_MIN                        6    // 电压最小值
